...
names = ['Rahyan Ramos','Cleidimara Sander','Gabriel Lopes Lima', 'Juliano Marca','Gilberto Piselo', 'Jesiel Carolino', 'Edinaldo']
usernames = ['rahyanramos.dev@gmail.com','Cleidi.Sander' ,'Gabriel.Lopes','Juliano.Marca','Gilberto.Piselo', 'Jesiel.Carolino', 'Edinaldo']
hashed_passwords = ['admin','admin','admin','admin','admin', 'admin', 'admin']
